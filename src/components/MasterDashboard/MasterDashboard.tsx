...
import { Calendar, Briefcase, Image as ImageIcon, Settings, BarChart3 } from 'lucide-react';
import { ServiceManager } from './ServiceManager';
import { PortfolioManager } from './PortfolioManager';

export function MasterDashboard() {
    const [activeSection, setActiveSection] = useState<'overview' | 'services' | 'portfolio'>('overview');
